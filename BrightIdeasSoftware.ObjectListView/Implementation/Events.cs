...
namespace BrightIdeasSoftware
{
	...
	public class ItemsAddingEventArgs : CancellableEventArgs
	{
		...
		public ItemsAddingEventArgs(ICollection<object> objectsToAdd)
		{
		...
		/// <param name="objectsToAdd"></param>
		public ItemsAddingEventArgs(int index, ICollection<object> objectsToAdd)
		{
			Index = index;
			ObjectsToAdd = objectsToAdd;
		}
		...
		/// </summary>
		public ICollection<object> ObjectsToAdd;
	}
	...
	public class ItemsChangingEventArgs : CancellableEventArgs
	{
		...
		public ItemsChangingEventArgs(IEnumerable<object> oldObjects, IEnumerable<object> newObjects)
		{
		...
		/// </summary>
		public IEnumerable<object> OldObjects
		{
			get { return oldObjects; }
		}
		private IEnumerable<object> oldObjects;

		/// <summary>
		/// Gets or sets the objects that will be in the list after it changes.
		/// </summary>
		public IEnumerable<object> NewObjects;
	}
	...
	public class ItemsRemovingEventArgs : CancellableEventArgs
	{
		...
		public ItemsRemovingEventArgs(ICollection<object> objectsToRemove)
		{
		...
		/// </summary>
		public ICollection<object> ObjectsToRemove;
	}
